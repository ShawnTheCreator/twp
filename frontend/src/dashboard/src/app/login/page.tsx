    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-md bg-white border border-gray-200 p-10 rounded-xl">
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-3xl font-bold text-black uppercase tracking-widest text-center">Welcome Back</h1>
          <p className="text-sm text-gray-500 mt-2 uppercase tracking-widest text-center">Sign in to your workspace</p>
        </div>
